  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center py-6 md:py-12 overflow-x-hidden bg-[#050608] font-sans">
      ...
      <section className="z-10 w-full max-w-[1400px] px-4 md:px-12 mb-12 md:mb-24">
        <div className="relative w-full aspect-[1.8/1] md:aspect-[3/1] lg:aspect-[3.5/1] rounded-2xl md:rounded-[2.5rem] overflow-hidden border border-white/10 shadow-2xl group">
          ...
          <div className="absolute inset-0 flex items-center justify-center px-6 md:px-16 lg:px-24">
            <div className="max-w-[320px] md:max-w-2xl text-center flex flex-col items-center space-y-4 md:space-y-6">
              <div className="inline-block px-4 py-1.5 md:px-6 md:py-2 rounded-full bg-cyan-500/20 border border-cyan-500/30 text-cyan-400 text-[10px] md:text-sm font-black uppercase tracking-[0.2em] backdrop-blur-sm">
                Terpercaya & Cepat
              </div>
              <h1 className="text-2xl md:text-5xl lg:text-7xl font-black leading-tight text-white drop-shadow-[0_2px_15px_rgba(0,0,0,0.9)] uppercase italic">
                <span className="text-cyan-400">PUSH RANK</span> <br />
                <span className="text-white">TANPA LOSE STREAK</span>
              </h1>
              <p className="text-[11px] md:text-lg text-white/80 font-medium max-w-[260px] md:max-w-lg leading-relaxed drop-shadow-md">
                Dapatkan rank impianmu sekarang. Tim pro player kami siap membantu kamu naik dengan cepat dan aman.
              </p>
              <div className="flex gap-4 justify-center pt-2 md:pt-4">
                <a href="#services" className="px-7 py-3.5 md:px-14 md:py-6 bg-cyan-500 text-black rounded-xl font-black text-xs md:text-xl hover:scale-105 transition-all shadow-xl shadow-cyan-500/40 active:scale-95 uppercase tracking-tight">
                  Order Sekarang
                </a>
              </div>
            </div>
      ...
      <section id="services" className="z-10 w-full max-w-6xl px-6 md:px-12 mb-20 md:mb-32">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 md:gap-10 text-white leading-none">
          {rankServices.map((service) => (
            <div key={service.id} className="bg-[#0E1016] group p-5 md:p-12 rounded-[1.8rem] md:rounded-[2.5rem] border border-white/5 hover:border-cyan-500/40 transition-all duration-500 hover:translate-y-[-10px] flex flex-col items-center text-center relative overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
          ...
          <div className="bg-[#12141C] w-full max-w-md p-6 md:p-10 rounded-2xl md:rounded-[2.5rem] border border-cyan-500/20 relative overflow-y-auto max-h-[95vh] shadow-2xl custom-scrollbar">
            ...
            <div className="space-y-5">
              ...
              <div className="pt-4 border-t border-white/5 flex justify-between items-center px-1">
                <p className="text-xs font-bold text-white/40 uppercase tracking-wider">Total Harga</p>
                <p className="text-2xl md:text-3xl font-black text-cyan-400 italic">Rp {(selectedPackage.price * formData.stars).toLocaleString()}</p>
              </div>
      ...
      {/* Policy Modal */}
      {policyModal && (
        <div className="fixed inset-0 z-[110] flex items-center justify-center p-2 md:p-4 bg-black/95 backdrop-blur-md animate-in fade-in duration-300">
          <div className="glass w-full max-w-2xl p-6 md:p-12 rounded-2xl md:rounded-[2.5rem] border-brand-primary/30 relative max-h-[90vh] overflow-y-auto custom-scrollbar">
            <button
